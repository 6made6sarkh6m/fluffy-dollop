...
const thirdObj = {...firstObj};/// Spread operator берет и разворачивает твой обьект пробигаясь по каждому элементу и
                                /// записывая его в нужную переменную.
                                /// Кстати это один из вариантов поверхностного копирования обьектов
